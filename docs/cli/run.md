...
* `--model MODEL`: LLM model for the main workflow (e.g. `gpt-5-mini`). Overrides the `CLERK_DEFAULT_MODEL` environment variable.
...
uv run clerk run demo --auto-evaluate --judge-model gpt-5-mini

    ...
    <div className="max-w-2xl mx-auto py-20 fade-in">
      <div className="glass-card text-center py-16 px-8">
        ...
        <p className="text-lg text-muted-foreground mb-6">
          Thanks for signing up for early access. You're now part of the CLERK
          community.
        </p>
        ...
        <div className="bg-muted/50 rounded-lg p-6 mb-8">
          ...
          <ul className="text-sm text-muted-foreground space-y-2 text-left">
            <li className="flex items-start gap-2">
              ...
              <span>
                Full access to the kit marketplace and reasoning workflows
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
        ...
        <p className="text-sm text-muted-foreground mb-8">
          We'll notify you via email as soon as full access is available. In the
          meantime, check out the documentation and GitHub repository.
        </p>
